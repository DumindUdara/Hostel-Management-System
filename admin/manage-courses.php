            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <a href="add-courses.php"><button type="button"
                                        class="btn btn-block btn-md btn-success">Add New Course Details</button></a>
                                <hr>
                                    ...
                                    <table id="zero_config"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="edit-courses.php?id=<?php echo $row->id;?>" title="Edit"><i
                                                            class="icon-note"></i></a>&nbsp;&nbsp;
                                                    <a href="manage-courses.php?del=<?php echo $row->id;?>"
                                                        title="Delete" onclick="return confirm(" Do you want to
                                                        delete");"><i class="icon-close" style="color:red;"></i></a>
                                                </td>
                                            </tr>
                                            <?php
                                                $cnt=$cnt+1;
