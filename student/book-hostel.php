...
<body>
    ...
    <!-- Preloader - style I can find in spinners.css -->
    <div class="preloader">
    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <!-- Topbar header - style I can find in pages.scss -->
        <header class="topbar" data-navbarbg="skin6">
            <?php include '../includes/student-navigation.php'?>
        </header>
        <!-- End Topbar header -->

        <!-- Left Sidebar - style I can find in sidebar.scss  -->
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="custom-control custom-radio">
                                        ...
                                        <label class="custom-control-label" for="customRadio1">Required
                                            <code>Extra Rs.15000 Per Month</code></label>
                                    </div>
                                    <div class="custom-control custom-radio">
                ...
                $aid=$_SESSION['id'];
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <input type="number" name="econtact" id="econtact" class="form-control"
                                            required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h6 class="card-subtitle">
                                        <code>Ignore this CHECK BOX if you have different permanent address</code>
                                    </h6>
                                    <fieldset class="checkbox">
                                        <label>
                                            <input type="checkbox" value="1" name="adcheck"> My permanent address is
                                            same as above!
                                        </label>
                                    </fieldset>
                    ...
                    <h5 class="card-title mt-5">Please fill up the form "ONLY IF" you've different permanent address!
                    </h5>
